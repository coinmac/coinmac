    ...
    <div class="row">
        <div class="col-md-12">
                <div class="title-section">
                    <h1 class="title">CERTIFICATION COURSES BROCHURE</h1>
                    <div class="sub-title">
                        Download our {{date("Y")}}'s Ceritification Courses Brochure
                    </div>
                </div>
        </div><!-- col.md-12 -->
    </div>
...
<div class="container">
        ...
        <div class="row">
           <div class="col-md-4">
               <img src="/images/content/brochure_cert.jpg" alt="2019 National Brochure" style="width: 200px !important">
           </div>
